...
def upgrade() -> None:
    ...
    op.create_table('valuechangelog',
    ...
    sa.Column('programmeDuration', sa.String(length=32767), nullable=False),
    ...
    sa.Column('resolutionHorizontalPixels', sa.String(length=32767), nullable=False),
    sa.Column('resolutionVerticalPixels', sa.String(length=32767), nullable=False),
    ...
    sa.Column('consolidatedEnergyConsAnnual', sa.String(length=32767), nullable=False),
    ...
    sa.Column('loadCapacityIndex', sa.String(length=32767), nullable=False),
    sa.Column('loadCapacityIndex2', sa.String(length=32767), nullable=False),
    sa.Column('loadCapacityIndex3', sa.String(length=32767), nullable=False),
    sa.Column('loadCapacityIndex4', sa.String(length=32767), nullable=False),
    sa.Column('speedCategorySymbol', sa.String(length=32767), nullable=False),
    sa.Column('speedCategorySymbol2', sa.String(length=32767), nullable=False),
    sa.Column('loadCapacityIndicator', sa.String(length=32767), nullable=False),
    sa.Column('tyreClass', sa.String(length=32767), nullable=False),
    sa.Column('energyClass', sa.String(length=32767), nullable=False),
    sa.Column('wetGripClass', sa.String(length=32767), nullable=False),
    sa.Column('externalRollingNoiseValue', sa.String(length=32767), nullable=False),
    sa.Column('externalRollingNoiseClass', sa.String(length=32767), nullable=False),
    ...
    sa.Column('energyClassWashAndDry', sa.String(length=32767), nullable=False),
    sa.Column('energyClassWash', sa.String(length=32767), nullable=False),
    sa.Column('energyConsumption100WashAndDry', sa.String(length=32767), nullable=False),
    sa.Column('energyConsumption100Wash', sa.String(length=32767), nullable=False),
    sa.Column('ratedCapacityWashAndDry', sa.String(length=32767), nullable=False),
    sa.Column('ratedCapacityWash', sa.String(length=32767), nullable=False),
    sa.Column('waterConsumptionWashAndDry', sa.String(length=32767), nullable=False),
    sa.Column('waterConsumptionWash', sa.String(length=32767), nullable=False),
    sa.Column('programDurationRatedWashAndDry', sa.String(length=32767), nullable=False),
    sa.Column('programDurationRatedWash', sa.String(length=32767), nullable=False),
    ...
    sa.Column('energyClass', sa.String(length=32767), nullable=False),
    sa.Column('energyConsPerCycle', sa.String(length=32767), nullable=False),
    sa.Column('energyConsPer100Cycle', sa.String(length=32767), nullable=False),
    sa.Column('ratedCapacity', sa.String(length=32767), nullable=False),
    sa.Column('programmeDurationRated', sa.String(length=32767), nullable=False),
    sa.Column('waterCons', sa.String(length=32767), nullable=False),
    sa.Column('spinClass', sa.String(length=32767), nullable=False),
    sa.Column('noise', sa.String(length=32767), nullable=False),
    sa.Column('noiseClass', sa.String(length=32767), nullable=False),
